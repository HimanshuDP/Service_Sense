...
def build_dataset() -> pd.DataFrame:
    """
    Load dataset from CSV if it exists (generated by fetch_real_dataset.py).
    Otherwise, fallback to synthetic samples.
    """
    csv_path = os.path.join(os.path.dirname(__file__), "real_environmental_dataset.csv")
